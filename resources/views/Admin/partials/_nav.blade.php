               ...
               <ul class="nav metismenu" id="side-menu">
                  <li class="nav-header">
                     <div class=" profile-element"> 
                        <span>
                        <img alt="image" class="img-circle" src="{{ asset('admin/img/mena.jpg') }}" style="max-width: 50px; max-height: 50px;" />
                        </span>
                        <a>
                 ...
                 <!--  <li>
                  ...
                  <li>
                     ...
                     <ul class="nav nav-second-level collapse in">
                        <li ><a href="/admin/cover_home">Cover</a></li>
                        <li class="active"><a href="/admin/welcome">Wellcome </a></li>
                        <li><a href="/admin/feature">Feature </a></li>
                        <li><a href="/admin/app_services"> App services</a></li>
                     </ul>
                  </li>
                  <li>
                     <a href="slide.php"><i class="fa fa-th-large"></i> <span class="nav-label">Testimonials</span> <span class="fa arrow"></span></a>
                     <ul class="nav nav-second-level collapse">
                        <li><a href="/admin/online_clients">All Clients</a></li>
                        <li><a href="/admin/add_client">Add Client</a></li>
                     </ul>
                  </li>
                    <li>
                     <a href="slide.php"><i class="fa fa-th-large"></i> <span class="nav-label">Contact Us</span> <span class="fa arrow"></span></a>
                     <ul class="nav nav-second-level collapse">
                        <li><a href="/admin/contact_us"> Contact</a></li>
                     </ul>
                  </li>
                  <li>
                  ...
                  <li>
                     ...
                     <ul class="nav nav-second-level collapse">
                         <li><a href="/admin/cover_blog">Blog Cover</a></li>
                        <li><a href="/admin/ios">IOS</a></li>
                        <li><a href="/admin/android">Android</a></li>
                     </ul>
                  </li>
                  <li>
                     ...
                     <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="/admin/add_blog">Add Blog</a></li>
                        <li><a href="/admin/all_blog">All Blog</a></li>
                     </ul>
                  </li>
                  <li>
                     <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Message & Subscribe</span> <span class="fa arrow"></span></a>
                     <ul class="nav nav-second-level collapse in">
                      
                        <li class="active"><a href="/admin/msg">Message From User</a></li>
                     </ul>
                  </li>
